...
const Service: React.FC<{ slug?: string }> = ({ slug }) => {
  ...
  // Get all services and the current service
  const { data: services } = useQuery<ServiceType[]>({
    queryKey: ["/api/services"],
    initialData: SAMPLE_SERVICES,
  });
  
  // If we're on the main services page
  if (!currentSlug) {
    return (
      <motion.div
        initial={{ opacity: 0 }}
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            >
              <div className="mb-8">
                ...
                <h1 className="text-4xl md:text-5xl font-display font-bold text-[#5A3E36] mb-6">{service.title}</h1>
                <div className="relative rounded-2xl overflow-hidden h-64 md:h-80 lg:h-96 mb-8">
                  <img 
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-lg text-[#2B2B2B]/80 mb-6">{service.description}</p>
                  
                  <h2 className="text-2xl font-bold text-[#5A3E36] mb-4">How We Help</h2>
                  ...
                  <h2 className="text-2xl font-bold text-[#5A3E36] mb-4">Key Features</h2>
                  ...
                  <h2 className="text-2xl font-bold text-[#5A3E36] mb-4">Our Approach</h2>
                  <p className="text-[#2B2B2B]/80 mb-6">
                  ...
                  <div className="my-10 bg-[#F7F5F2] p-6 rounded-xl border border-primary/10">
              ...
              <div className="sticky top-28">
                ...
                <Card className="glass rounded-2xl shadow-glass overflow-hidden">
                  <CardContent className="p-6">
                    ...
                    <div className="mt-6 pt-6 border-t border-[#5A3E36]/10">
