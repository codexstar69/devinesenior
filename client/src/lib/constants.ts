...
export const WHY_CHOOSE_US_CARDS = [
  {
    ...
    description: "Tailored support designed around each resident's unique needs, preferences and abilities.",
    icon: "user-md",
    color: "primary"
  },
  {
    title: "Award-Winning Staff",
    description: "Our team includes recognized specialists with decades of senior care experience.",
    icon: "medal",
    color: "accent"
  },
  {
    title: "Holistic Wellness",
    description: "Programs that nurture mind, body, and spirit through research-backed approaches.",
    icon: "heart",
    color: "green"
  },
  {
    title: "Culinary Excellence",
    description: "Restaurant-quality dining with chef-prepared meals using fresh, seasonal ingredients.",
    icon: "utensils",
    color: "primary"
  },
  {
    title: "Luxurious Environments",
    description: "Thoughtfully designed spaces that combine comfort, safety, and sophisticated aesthetics.",
    icon: "home",
    color: "accent"
  },
  {
    title: "Enrichment Programs",
    description: "Diverse activities and events that inspire connection, creativity, and continued learning.",
    icon: "calendar-check",
    color: "green"
  }
];
